                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="intro-text">
                            ...
                            <hr class="star-light">
                            <span class="skills">Exercise the way you want.
                                                                    <br> &nbsp;</span>
                        </div>
                    </div>
                </div>
                        ...
                        <form id="loginform" class="form-horizontal" role="form" action="login.php" method="POST">
                            ...
                            <div style="margin-top:10px" class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                  ...
                                  <input id="btn-login" type="submit" class="btn btn-success" value="Login" onClick="document.getElementById('loginform').submit()"> 
            ...
            <div class="row">
                ...
                <div class="col-md-6 portfolio-item">
                    <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        ...
                        <center><img src="img/workouts/core.png" class="img-responsive" alt="" width="250px" height = "250px"></center>
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <hr class="star-primary">
                            <img src="img/workouts/Core.png" class="img-responsive img-centered" alt="" width="300px" height="300px">
